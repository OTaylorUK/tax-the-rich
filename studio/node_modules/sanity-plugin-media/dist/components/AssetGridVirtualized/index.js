...
var CARD_HEIGHT = 220;
var CARD_WIDTH = 240;
var VirtualCell = (0, react_1.memo)(function (_a) {
...
var AssetGridVirtualized = function (props) {
    ...
    // Redux
    var selectedAssets = (0, useTypedSelector_1.default)(function (state) { return state.selected.assets; });
    ...
    return (react_1.default.createElement(react_virtuoso_1.VirtuosoGrid, { className: "media__custom-scrollbar", computeItemKey: function (index) {
        ...
        }, overscan: 48, style: { overflowX: 'hidden' }, totalCount: totalCount }));
};
