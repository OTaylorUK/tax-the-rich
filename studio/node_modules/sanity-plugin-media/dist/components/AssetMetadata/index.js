    ...
    return (react_1.default.createElement(ui_1.Box, { marginTop: 3 },
        react_1.default.createElement(ui_1.Box, null,
            react_1.default.createElement(ui_1.Stack, { space: 3 },
                react_1.default.createElement(Row, { label: "Size", value: (0, filesize_1.default)(asset === null || asset === void 0 ? void 0 : asset.size, { base: 10, round: 0 }) }),
                ...
                (0, typeGuards_1.isImageAsset)(asset) && react_1.default.createElement(Row, { label: "Dimensions", value: (0, getAssetResolution_1.default)(asset) }))),
        exif && (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            react_1.default.createElement(ui_1.Box, null,
                react_1.default.createElement(ui_1.Stack, { space: 3 },
                    ...
                    exif.FNumber && react_1.default.createElement(Row, { label: "Aperture", value: "\u0192/".concat(exif.FNumber) }),
                    exif.FocalLength && react_1.default.createElement(Row, { label: "Focal length", value: "".concat(exif.FocalLength, "mm") }),
                    exif.ExposureTime && (react_1.default.createElement(Row, { label: "Exposure time", value: "1/".concat(1 / exif.ExposureTime) })),
                    exif.DateTimeOriginal && (react_1.default.createElement(Row, { label: "Original date", value: (0, format_1.default)(new Date(exif.DateTimeOriginal), 'PPp') })))))),
