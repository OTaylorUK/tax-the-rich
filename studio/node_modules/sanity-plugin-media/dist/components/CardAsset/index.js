...
var CardWrapper = (0, styled_components_1.default)(ui_1.Flex)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  box-sizing: border-box;\n  height: 100%;\n  overflow: hidden;\n  padding: 2px;\n  position: relative;\n  width: 100%;\n"], ["\n  box-sizing: border-box;\n  height: 100%;\n  overflow: hidden;\n  padding: 2px;\n  position: relative;\n  width: 100%;\n"])));
var CardContainer = (0, styled_components_1.default)(ui_1.Flex)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  border: 1px solid transparent;\n  height: 100%;\n  pointer-events: ", ";\n  position: relative;\n  transition: all 300ms;\n  user-select: none;\n  width: 100%;\n\n  border: ", ";\n\n  ", "\n"], ["\n  border: 1px solid transparent;\n  height: 100%;\n  pointer-events: ", ";\n  position: relative;\n  transition: all 300ms;\n  user-select: none;\n  width: 100%;\n\n  border: ", ";\n\n  ", "\n"])), function (props) { return (props.updating ? 'none' : 'auto'); }, function (props) {
    return props.picked
        ? "1px solid ".concat(props.theme.sanity.color.spot.orange, " !important")
        : '1px solid inherit';
}, function (props) {
    return !props.updating && (0, styled_components_1.css)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n      @media (hover: hover) and (pointer: fine) {\n        &:hover {\n          border: 1px solid ", ";\n        }\n      }\n    "], ["\n      @media (hover: hover) and (pointer: fine) {\n        &:hover {\n          border: 1px solid ", ";\n        }\n      }\n    "])), color_1.hues.gray[500].hex);
});
var ContextActionContainer = (0, styled_components_1.default)(ui_1.Flex)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  cursor: ", ";\n  height: ", "px;\n  transition: all 300ms;\n\n  @media (hover: hover) and (pointer: fine) {\n    &:hover {\n      background: ", ";\n    }\n  }\n"], ["\n  cursor: ", ";\n  height: ", "px;\n  transition: all 300ms;\n\n  @media (hover: hover) and (pointer: fine) {\n    &:hover {\n      background: ", ";\n    }\n  }\n"])), function (props) { return (props.selected ? 'default' : 'pointer'); }, constants_1.PANEL_HEIGHT, color_1.hues.gray[950].hex);
var StyledWarningOutlineIcon = (0, styled_components_1.default)(icons_1.WarningFilledIcon)(function (_a) {
    var theme = _a.theme;
    return {
        ...
        react_1.default.createElement(CardContainer, { direction: "column", picked: picked, updating: item.updating },
            react_1.default.createElement(ui_1.Box, { flex: 1, style: {
                ...
                react_1.default.createElement("div", { onClick: handleAssetClick, style: { height: '100%', opacity: opacityPreview } },
                    (0, typeGuards_1.isFileAsset)(asset) && react_1.default.createElement(FileIcon_1.default, { extension: asset.extension, width: "80px" }),
                    (0, typeGuards_1.isImageAsset)(asset) && (react_1.default.createElement(Image_1.default, { draggable: false, showCheckerboard: !isOpaque, src: (0, imageDprUrl_1.default)(asset, { height: 250, width: 250 }), style: {
                            draggable: false,
...
exports.default = (0, react_1.memo)(CardAsset);
