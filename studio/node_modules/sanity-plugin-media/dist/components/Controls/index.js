...
var Controls = function () {
    ...
    var fetching = (0, useTypedSelector_1.default)(function (state) { return state.assets.fetching; });
    var pageIndex = (0, useTypedSelector_1.default)(function (state) { return state.assets.pageIndex; });
    var searchFacets = (0, useTypedSelector_1.default)(function (state) { return state.search.facets; });
    var tagsPanelVisible = (0, useTypedSelector_1.default)(function (state) { return state.tags.panelVisible; });
    ...
    return (react_1.default.createElement(ui_1.Box, { paddingY: 2, style: {
            borderBottom: "1px solid ".concat((_a = color_1.hues.gray) === null || _a === void 0 ? void 0 : _a[900].hex),
            zIndex: 2
        } },
        react_1.default.createElement(ui_1.Box, { marginBottom: 2 },
            react_1.default.createElement(ui_1.Flex, { align: "flex-start", direction: ['column', 'column', 'column', 'column', 'row'], justify: "space-between" },
                react_1.default.createElement(ui_1.Flex, { flex: 1, style: {
                    ...
                    react_1.default.createElement(ui_1.Box, { display: ['block', 'block', 'none'], marginX: 2 },
                        react_1.default.createElement(ui_1.Inline, { space: 2, style: { whiteSpace: 'nowrap' } },
                            react_1.default.createElement(ui_1.Button, { fontSize: 1, mode: "ghost", onClick: handleShowSearchFacetDialog, text: "Filters".concat(searchFacets.length > 0 ? " (".concat(searchFacets.length, ")") : ''), tone: "primary" }),
