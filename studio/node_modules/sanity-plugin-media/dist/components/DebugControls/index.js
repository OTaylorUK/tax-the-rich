...
var DebugControls = function () {
    ...
    var badConnection = (0, useTypedSelector_1.default)(function (state) { return state.debug.badConnection; });
    var debugEnabled = (0, useTypedSelector_1.default)(function (state) { return state.debug.enabled; });
    // Callbacks
    ...
    (0, useKeyPress_1.default)('alt+ctrl+shift+/', handleToggleControls);
    if (!debugEnabled) {
        return null;
    }
