...
var Items = function () {
    ...
    var fetchCount = (0, useTypedSelector_1.default)(function (state) { return state.assets.fetchCount; });
    ...
    var combinedItems = (0, useTypedSelector_1.default)(selectors_1.selectCombinedItems);
    var breakpointIndex = (0, useBreakpointIndex_1.default)();
