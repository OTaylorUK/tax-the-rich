...
var SearchFacetNumber = function (props) {
    ...
    var selectedModifier = (facet === null || facet === void 0 ? void 0 : facet.modifier)
        ? modifiers === null || modifiers === void 0 ? void 0 : modifiers.find(function (modifier) { return modifier.name === (facet === null || facet === void 0 ? void 0 : facet.modifier); })
        : modifiers === null || modifiers === void 0 ? void 0 : modifiers[0];
    var handleOperatorItemClick = function (operatorType) {
        dispatch(search_1.searchActions.facetsUpdateById({ id: facet.id, operatorType: operatorType }));
    };
    var handleModifierClick = function (modifier) {
        dispatch(search_1.searchActions.facetsUpdateById({ id: facet.id, modifier: modifier.name }));
    };
    var handleValueChange = function (value) {
        dispatch(search_1.searchActions.facetsUpdateById({ id: facet.id, value: value }));
    };
