...
var StackContainer = (0, styled_components_1.default)(ui_1.Flex)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  > * {\n    margin-bottom: ", "px;\n  }\n"], ["\n  > * {\n    margin-bottom: ", "px;\n  }\n"])), function (props) { return props.theme.sanity.space[2]; });
var SearchFacets = function (props) {
    ...
    var Items = searchFacets.map(function (facet) {
        ...
        if (facet.type === 'number') {
            return react_1.default.createElement(SearchFacetNumber_1.default, { facet: facet, key: key });
        }
        if (facet.type === 'searchable') {
            return react_1.default.createElement(SearchFacetTags_1.default, { facet: facet, key: key });
        }
        if (facet.type === 'select') {
            return react_1.default.createElement(SearchFacetSelect_1.default, { facet: facet, key: key });
        }
        if (facet.type === 'string') {
            return react_1.default.createElement(SearchFacetString_1.default, { facet: facet, key: key });
        }
        return null;
    });
    if (layout === 'inline') {
