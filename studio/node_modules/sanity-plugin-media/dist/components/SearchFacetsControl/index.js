...
var SearchFacetsControl = function () {
    ...
    var assetTypes = (0, useTypedSelector_1.default)(function (state) { return state.assets.assetTypes; });
    var searchFacets = (0, useTypedSelector_1.default)(function (state) { return state.search.facets; });
    var selectedDocument = (0, useTypedSelector_1.default)(function (state) { return state.selected.document; });
    ...
    var hasSearchFacets = filteredFacets.length > 0;
    var renderMenuFacets = function (facets, level) {
        ...
        return (react_1.default.createElement(react_1.default.Fragment, null, facets === null || facets === void 0 ? void 0 : facets.map(function (facet, index) {
            ...
            if (facet.type === 'group') {
                return (react_1.default.createElement(ui_1.MenuGroup, { key: "group-".concat(level, "-").concat(index), text: facet.title, title: facet.title }, renderMenuFacets(facet.facets, level + 1)));
            }
            if (facet) {
                var disabled = !facet.operatorTypes && !!searchFacets.find(function (v) { return v.name === facet.name; });
                return (react_1.default.createElement(ui_1.MenuItem, { disabled: disabled, fontSize: 1, key: facet.name, onClick: function () { return dispatch(search_1.searchActions.facetsAdd({ facet: facet })); }, padding: 2, text: facet.title }));
            }
            return null;
        })));
    };
    return (react_1.default.createElement(ui_1.Flex, null,
        react_1.default.createElement(ui_1.MenuButton, { button: react_1.default.createElement(ui_1.Button, { disabled: !hasSearchFacets, fontSize: 1, icon: icons_1.AddCircleIcon, mode: "bleed", text: "Add filter", tone: "primary" }), id: "facets", menu: react_1.default.createElement(ui_1.Menu, null, renderMenuFacets(filteredFacets)), placement: "right-start", portal: true }),
