...
// TODO: DRY
var ContextActionContainer = (0, styled_components_1.default)(ui_1.Flex)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  cursor: pointer;\n\n  @media (hover: hover) and (pointer: fine) {\n    &:hover {\n      background: ", ";\n    }\n  }\n"], ["\n  cursor: pointer;\n\n  @media (hover: hover) and (pointer: fine) {\n    &:hover {\n      background: ", ";\n    }\n  }\n"])), (_a = color_1.hues.gray) === null || _a === void 0 ? void 0 : _a[900].hex);
var TableHeader = function () {
    var _a;
    // Redux
    var dispatch = (0, react_redux_1.useDispatch)();
    var fetching = (0, useTypedSelector_1.default)(function (state) { return state.assets.fetching; });
    var itemsLength = (0, useTypedSelector_1.default)(assets_1.selectAssetsLength);
    var numPickedAssets = (0, useTypedSelector_1.default)(assets_1.selectAssetsPickedLength);
    ...
    return (react_1.default.createElement(ui_1.Grid, { style: {
            ...
            gridTemplateColumns: constants_1.GRID_TEMPLATE_COLUMNS.LARGE,
            height: mediaIndex < 3 ? 0 : "".concat(constants_1.PANEL_HEIGHT, "px"),
