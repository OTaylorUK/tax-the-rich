...
var ContainerGrid = (0, styled_components_1.default)(ui_1.Grid)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  align-items: center;\n  cursor: ", ";\n  height: 100%;\n  pointer-events: ", ";\n  user-select: none;\n  white-space: nowrap;\n\n  ", "\n"], ["\n  align-items: center;\n  cursor: ", ";\n  height: 100%;\n  pointer-events: ", ";\n  user-select: none;\n  white-space: nowrap;\n\n  ", "\n"])), function (props) { return (props.selected ? 'default' : 'pointer'); }, function (props) { return (props.updating ? 'none' : 'auto'); }, function (props) {
    var _a;
    return !props.updating && (0, styled_components_1.css)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n      @media (hover: hover) and (pointer: fine) {\n        &:hover {\n          background: ", ";\n        }\n      }\n    "], ["\n      @media (hover: hover) and (pointer: fine) {\n        &:hover {\n          background: ", ";\n        }\n      }\n    "])), (_a = color_1.hues.gray) === null || _a === void 0 ? void 0 : _a[950].hex);
});
var ContextActionContainer = (0, styled_components_1.default)(ui_1.Flex)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  cursor: pointer;\n\n  @media (hover: hover) and (pointer: fine) {\n    &:hover {\n      background: ", ";\n    }\n  }\n"], ["\n  cursor: pointer;\n\n  @media (hover: hover) and (pointer: fine) {\n    &:hover {\n      background: ", ";\n    }\n  }\n"])), (_a = color_1.hues.gray) === null || _a === void 0 ? void 0 : _a[900].hex);
var StyledWarningIcon = (0, styled_components_1.default)(icons_1.WarningFilledIcon)(function (_a) {
    var theme = _a.theme;
    return {
...
var TableRowAsset = function (props) {
    ...
    // Refs
    var shiftPressed = (0, useKeyPress_1.default)('shift');
    // Redux
    var dispatch = (0, react_redux_1.useDispatch)();
    var lastPicked = (0, useTypedSelector_1.default)(function (state) { return state.assets.lastPicked; });
    var item = (0, useTypedSelector_1.default)(function (state) { return (0, assets_1.selectAssetById)(state, id); });
    ...
    var onSelect = (0, AssetSourceDispatchContext_1.useAssetSourceActions)().onSelect;
    ...
    return (react_1.default.createElement(ContainerGrid, { onClick: selected ? undefined : handleClick, selected: selected, style: {
        ...
        react_1.default.createElement(ContextActionContainer, { onClick: handleContextActionClick, style: {
                alignItems: 'center',
                gridColumn: 1,
                gridRowStart: 1,
                gridRowEnd: 'span 5',
        ...
        react_1.default.createElement(ui_1.Box, { style: {
            ...
            react_1.default.createElement(ui_1.Flex, { align: "center", justify: "center", style: { height: '100%', position: 'relative' } },
                react_1.default.createElement(ui_1.Box, { style: { height: '100%', opacity: opacityPreview, position: 'relative' } },
                    (0, typeGuards_1.isFileAsset)(asset) && react_1.default.createElement(FileIcon_1.default, { extension: asset.extension, width: "40px" }),
                    (0, typeGuards_1.isImageAsset)(asset) && (react_1.default.createElement(Image_1.default, { draggable: false, showCheckerboard: !isOpaque, src: (0, imageDprUrl_1.default)(asset, { height: 100, width: 100 }) }))),
        ...
        react_1.default.createElement(ui_1.Box, { marginLeft: mediaIndex < 3 ? 3 : 0, style: {
                gridColumn: 3,
        ...
        react_1.default.createElement(ui_1.Box, { marginLeft: mediaIndex < 3 ? 3 : 0, style: {
            ...
            react_1.default.createElement(ui_1.Text, { muted: true, size: 1, style: { lineHeight: '2em' }, textOverflow: "ellipsis" }, (0, typeGuards_1.isImageAsset)(asset) && (0, getAssetResolution_1.default)(asset))),
        react_1.default.createElement(ui_1.Box, { style: {
        ...
        react_1.default.createElement(ui_1.Box, { style: {
            ...
            react_1.default.createElement(ui_1.Text, { muted: true, size: 1, style: { lineHeight: '2em' }, textOverflow: "ellipsis" }, (0, filesize_1.default)(asset.size, { base: 10, round: 0 }))),
        react_1.default.createElement(ui_1.Box, { marginLeft: mediaIndex < 3 ? 3 : 0, style: {
                gridColumn: mediaIndex < 3 ? 3 : 7,
                gridRow: mediaIndex < 3 ? 4 : 'auto',
                opacity: opacityCell
            } },
            react_1.default.createElement(ui_1.Text, { muted: true, size: 1, style: { lineHeight: '2em' }, textOverflow: "ellipsis" }, (0, formatRelative_1.default)(new Date(asset._updatedAt), new Date()))),
        react_1.default.createElement(ui_1.Flex, { align: "center", justify: "center", style: {
                ...
                opacity: opacityCell
            } }, error && (react_1.default.createElement(ui_1.Box, { padding: 2 },
...
exports.default = (0, react_1.memo)(TableRowAsset);
