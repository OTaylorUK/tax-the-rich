...
var TagContainer = (0, styled_components_1.default)(ui_1.Flex)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  height: ", "px;\n"], ["\n  height: ", "px;\n"])), constants_1.PANEL_HEIGHT);
var ButtonContainer = (0, styled_components_1.default)(ui_1.Flex)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  @media (pointer: fine) {\n    visibility: hidden;\n  }\n\n  @media (hover: hover) and (pointer: fine) {\n    ", ":hover & {\n      visibility: visible;\n    }\n  }\n"], ["\n  @media (pointer: fine) {\n    visibility: hidden;\n  }\n\n  @media (hover: hover) and (pointer: fine) {\n    ", ":hover & {\n      visibility: visible;\n    }\n  }\n"])), TagContainer);
var TagButton = function (props) {
    ...
    return (react_1.default.createElement(ui_1.Tooltip, { content: react_1.default.createElement(ui_1.Container, { padding: 2, width: 0 },
            react_1.default.createElement(ui_1.Text, { muted: true, size: 1 }, tooltip)), disabled: 'ontouchstart' in window, placement: "top" },
...
var Tag = function (props) {
    ...
    var isSearchFacetTag = (0, useTypedSelector_1.default)(function (state) { var _a; return (0, search_1.selectIsSearchFacetTag)(state, (_a = tag === null || tag === void 0 ? void 0 : tag.tag) === null || _a === void 0 ? void 0 : _a._id); });
    // Callbacks
    var handleSearchFacetTagRemove = function () {
        dispatch(search_1.searchActions.facetsRemoveByTag({ tagId: tag.tag._id }));
    };
    ...
    return (react_1.default.createElement(TagContainer, { align: "center", flex: 1, justify: "space-between", paddingLeft: 3 },
