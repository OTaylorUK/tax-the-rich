...
var TagView = function () {
    ...
    var fetching = (0, useTypedSelector_1.default)(function (state) { return state.tags.fetching; });
    var fetchCount = (0, useTypedSelector_1.default)(function (state) { return state.tags.fetchCount; });
