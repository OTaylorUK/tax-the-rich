...
var VirtualRow = (0, react_1.memo)(function (_a) {
    var _b;
    var isScrolling = _a.isScrolling, item = _a.item;
    // Render label
    if (typeof item === 'string') {
        return (react_1.default.createElement(ui_1.Flex, { align: "center", justify: "space-between", key: item, paddingX: 3, style: { height: "".concat(constants_1.PANEL_HEIGHT, "px") } },
...
var TagsVirtualized = function () {
    ...
    // State
    var _a = __read((0, react_1.useState)(false), 2), isScrolling = _a[0], setIsScrolling = _a[1];
    ...
    var pickedTagIdsUnique = __spreadArray([], __read(new Set(pickedTagIds)), false);
