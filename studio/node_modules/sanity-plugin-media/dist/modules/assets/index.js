...
exports.initialState = {
    ...
    order: {
        ...
        title: (0, orders_1.getOrderTitle)(defaultOrder.field, defaultOrder.direction)
    },
    pageIndex: 0,
    pageSize: 50,
    // totalCount: -1,
...
var assetsSlice = (0, toolkit_1.createSlice)({
    name: 'assets',
    ...
    reducers: {
        ...
        fetchRequest: {
            ...
            prepare: function (_a) {
                var _b = _a.params, params = _b === void 0 ? {} : _b, queryFilter = _a.queryFilter, _c = _a.selector, selector = _c === void 0 ? "" : _c, _d = _a.sort, sort = _d === void 0 ? (0, groq_1.default)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["order(_updatedAt desc)"], ["order(_updatedAt desc)"]))) : _d;
                var pipe = sort || selector ? '|' : '';
                // Construct query
                var query = (0, groq_1.default)(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n          {\n            \"items\": *[", "] {\n              _id,\n              _type,\n              _createdAt,\n              _updatedAt,\n              altText,\n              description,\n              extension,\n              metadata {\n                dimensions,\n                exif,\n                isOpaque,\n              },\n              mimeType,\n              opt {\n                media\n              },\n              originalFilename,\n              size,\n              title,\n              url\n            } ", " ", " ", ",\n          }\n        "], ["\n          {\n            \"items\": *[", "] {\n              _id,\n              _type,\n              _createdAt,\n              _updatedAt,\n              altText,\n              description,\n              extension,\n              metadata {\n                dimensions,\n                exif,\n                isOpaque,\n              },\n              mimeType,\n              opt {\n                media\n              },\n              originalFilename,\n              size,\n              title,\n              url\n            } ", " ", " ", ",\n          }\n        "])), queryFilter, pipe, sort, selector);
...
var assetsDeleteEpic = function (action$) {
    return action$.pipe((0, operators_1.filter)(exports.assetsActions.deleteRequest.match), (0, operators_1.mergeMap)(function (action) {
        var assets = action.payload.assets;
        var assetIds = assets.map(function (asset) { return asset._id; });
        return (0, rxjs_1.of)(assets).pipe((0, operators_1.mergeMap)(function () {
            return client_1.client.observable.delete({
                query: (0, groq_1.default)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["*[_id in ", "]"], ["*[_id in ", "]"])), JSON.stringify(assetIds))
            });
        }), (0, operators_1.mergeMap)(function () { return (0, rxjs_1.of)(exports.assetsActions.deleteComplete({ assetIds: assetIds })); }), (0, operators_1.catchError)(function (error) {
            return (0, rxjs_1.of)(exports.assetsActions.deleteError({ assetIds: assetIds, error: error }));
        }));
    }));
};
exports.assetsDeleteEpic = assetsDeleteEpic;
var assetsFetchEpic = function (action$, state$) {
    return action$.pipe((0, operators_1.filter)(exports.assetsActions.fetchRequest.match), (0, operators_1.withLatestFrom)(state$), (0, operators_1.switchMap)(function (_a) {
        var _b, _c;
        ...
        return (0, rxjs_1.of)(action).pipe((0, debugThrottle_1.default)(state.debug.badConnection), (0, operators_1.mergeMap)(function () {
            return client_1.client.observable.fetch(query, params);
        }), (0, operators_1.mergeMap)(function (result) {
            var items = result.items
            // totalCount
            ;
            return (0, rxjs_1.of)(exports.assetsActions.fetchComplete({ assets: items }));
        }), (0, operators_1.catchError)(function (error) {
            return (0, rxjs_1.of)(exports.assetsActions.fetchError({
...
var assetsFetchPageIndexEpic = function (action$, state$) {
    return action$.pipe((0, operators_1.filter)(exports.assetsActions.loadPageIndex.match), (0, operators_1.withLatestFrom)(state$), (0, operators_1.switchMap)(function (_a) {
        ...
        var constructedFilter = (0, constructFilter_1.default)({
        ...
        return (0, rxjs_1.of)(exports.assetsActions.fetchRequest({
            params: params,
            queryFilter: constructedFilter,
            selector: (0, groq_1.default)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["[", "...", "]"], ["[", "...", "]"])), start, end),
            sort: (0, groq_1.default)(templateObject_5 || (templateObject_5 = __makeTemplateObject(["order(", " ", ")"], ["order(", " ", ")"])), (_e = (_d = state.assets) === null || _d === void 0 ? void 0 : _d.order) === null || _e === void 0 ? void 0 : _e.field, (_g = (_f = state.assets) === null || _f === void 0 ? void 0 : _f.order) === null || _g === void 0 ? void 0 : _g.direction)
        }));
    }));
};
exports.assetsFetchPageIndexEpic = assetsFetchPageIndexEpic;
var assetsFetchNextPageEpic = function (action$, state$) {
    return action$.pipe((0, operators_1.filter)(exports.assetsActions.loadNextPage.match), (0, operators_1.withLatestFrom)(state$), (0, operators_1.switchMap)(function (_a) {
        var _b = __read(_a, 2), _action = _b[0], state = _b[1];
        return (0, rxjs_1.of)(exports.assetsActions.loadPageIndex({ pageIndex: state.assets.pageIndex + 1 }));
    }));
};
exports.assetsFetchNextPageEpic = assetsFetchNextPageEpic;
var assetsFetchAfterDeleteAllEpic = function (action$, state$) {
    return action$.pipe((0, operators_1.filter)(exports.assetsActions.deleteComplete.match), (0, operators_1.withLatestFrom)(state$), (0, operators_1.switchMap)(function (_a) {
        var _b = __read(_a, 2), _action = _b[0], state = _b[1];
        if (state.assets.allIds.length === 0) {
            var nextPageIndex = Math.floor(state.assets.allIds.length / state.assets.pageSize);
            return (0, rxjs_1.of)(exports.assetsActions.loadPageIndex({ pageIndex: nextPageIndex }));
        }
...
var patchOperationTagAppend = function (_a) {
    ...
    return function (patch) {
        return patch
            ...
            .append('opt.media.tags', [{ _key: (0, nanoid_1.nanoid)(), _ref: tag === null || tag === void 0 ? void 0 : tag._id, _type: 'reference', _weak: true }]);
    };
};
var patchOperationTagUnset = function (_a) {
    var asset = _a.asset, tag = _a.tag;
    return function (patch) { var _a; return patch.ifRevisionId((_a = asset === null || asset === void 0 ? void 0 : asset.asset) === null || _a === void 0 ? void 0 : _a._rev).unset(["opt.media.tags[_ref == \"".concat(tag._id, "\"]")]); };
};
var assetsRemoveTagsEpic = function (action$, state$) {
    return action$.pipe((0, operators_1.filter)(exports.assetsActions.tagsAddRequest.match), (0, operators_1.withLatestFrom)(state$), (0, operators_1.mergeMap)(function (_a) {
        var _b = __read(_a, 2), action = _b[0], state = _b[1];
        var _c = action.payload, assets = _c.assets, tag = _c.tag;
        return (0, rxjs_1.of)(action).pipe(
        // Optionally throttle
        (0, debugThrottle_1.default)(state.debug.badConnection), 
        // Add tag references to all picked assets
        (0, operators_1.mergeMap)(function () {
            var pickedAssets = (0, exports.selectAssetsPicked)(state);
            ...
            return (0, rxjs_1.from)(transaction.commit());
        }), 
        // Dispatch complete action
        (0, operators_1.mergeMap)(function () { return (0, rxjs_1.of)(exports.assetsActions.tagsAddComplete({ assets: assets, tag: tag })); }), (0, operators_1.catchError)(function (error) {
            return (0, rxjs_1.of)(exports.assetsActions.tagsAddError({
                assets: assets,
                error: {
                    message: (error === null || error === void 0 ? void 0 : error.message) || 'Internal error',
                    statusCode: (error === null || error === void 0 ? void 0 : error.statusCode) || 500
...
var assetsOrderSetEpic = function (action$) {
    return action$.pipe((0, operators_1.filter)(exports.assetsActions.orderSet.match), (0, operators_1.mergeMap)(function () {
        return (0, rxjs_1.of)(exports.assetsActions.clear(), //
...
var assetsSearchEpic = function (action$) {
    return action$.pipe((0, redux_observable_1.ofType)(search_1.searchActions.facetsAdd.type, search_1.searchActions.facetsClear.type, search_1.searchActions.facetsRemoveByName.type, search_1.searchActions.facetsRemoveByTag.type, search_1.searchActions.facetsRemoveById.type, search_1.searchActions.facetsUpdate.type, search_1.searchActions.facetsUpdateById.type, search_1.searchActions.querySet.type), (0, operators_1.debounceTime)(400), (0, operators_1.mergeMap)(function () {
        return (0, rxjs_1.of)(exports.assetsActions.clear(), //
        exports.assetsActions.loadPageIndex({ pageIndex: 0 }));
    }));
};
...
var assetsListenerCreateQueueEpic = function (action$) {
    return action$.pipe((0, operators_1.filter)(exports.assetsActions.listenerCreateQueue.match), (0, operators_1.bufferTime)(2000), (0, operators_1.filter)(function (actions) { return actions.length > 0; }), (0, operators_1.mergeMap)(function (actions) {
        var assets = actions === null || actions === void 0 ? void 0 : actions.map(function (action) { return action.payload.asset; });
        return (0, rxjs_1.of)(exports.assetsActions.listenerCreateQueueComplete({ assets: assets }));
    }));
};
exports.assetsListenerCreateQueueEpic = assetsListenerCreateQueueEpic;
var assetsListenerDeleteQueueEpic = function (action$) {
    return action$.pipe((0, operators_1.filter)(exports.assetsActions.listenerDeleteQueue.match), (0, operators_1.bufferTime)(2000), (0, operators_1.filter)(function (actions) { return actions.length > 0; }), (0, operators_1.mergeMap)(function (actions) {
        var assetIds = actions === null || actions === void 0 ? void 0 : actions.map(function (action) { return action.payload.assetId; });
        return (0, rxjs_1.of)(exports.assetsActions.listenerDeleteQueueComplete({ assetIds: assetIds }));
    }));
};
exports.assetsListenerDeleteQueueEpic = assetsListenerDeleteQueueEpic;
var assetsListenerUpdateQueueEpic = function (action$) {
    return action$.pipe((0, operators_1.filter)(exports.assetsActions.listenerUpdateQueue.match), (0, operators_1.bufferTime)(2000), (0, operators_1.filter)(function (actions) { return actions.length > 0; }), (0, operators_1.mergeMap)(function (actions) {
        var assets = actions === null || actions === void 0 ? void 0 : actions.map(function (action) { return action.payload.asset; });
        return (0, rxjs_1.of)(exports.assetsActions.listenerUpdateQueueComplete({ assets: assets }));
    }));
};
...
var assetsSortEpic = function (action$) {
    return action$.pipe((0, redux_observable_1.ofType)(exports.assetsActions.insertUploads.type, exports.assetsActions.listenerUpdateQueueComplete.type, exports.assetsActions.updateComplete.type), (0, operators_1.mergeMap)(function () { return (0, rxjs_1.of)(exports.assetsActions.sort()); }));
};
...
var assetsTagsRemoveEpic = function (action$, state$) {
    return action$.pipe((0, operators_1.filter)(exports.assetsActions.tagsRemoveRequest.match), (0, operators_1.withLatestFrom)(state$), (0, operators_1.mergeMap)(function (_a) {
        var _b = __read(_a, 2), action = _b[0], state = _b[1];
        var _c = action.payload, assets = _c.assets, tag = _c.tag;
        return (0, rxjs_1.of)(action).pipe(
        // Optionally throttle
        ...
        // Dispatch complete action
        (0, operators_1.mergeMap)(function () { return (0, rxjs_1.of)(exports.assetsActions.tagsRemoveComplete({ assets: assets, tag: tag })); }), (0, operators_1.catchError)(function (error) {
            return (0, rxjs_1.of)(exports.assetsActions.tagsRemoveError({
                assets: assets,
                error: {
                    message: (error === null || error === void 0 ? void 0 : error.message) || 'Internal error',
                    statusCode: (error === null || error === void 0 ? void 0 : error.statusCode) || 500
...
var assetsUnpickEpic = function (action$) {
    return action$.pipe((0, redux_observable_1.ofType)(exports.assetsActions.orderSet.type, exports.assetsActions.viewSet.type, search_1.searchActions.facetsAdd.type, search_1.searchActions.facetsClear.type, search_1.searchActions.facetsRemoveByName.type, search_1.searchActions.facetsRemoveByTag.type, search_1.searchActions.facetsRemoveById.type, search_1.searchActions.facetsUpdate.type, search_1.searchActions.facetsUpdateById.type, search_1.searchActions.querySet.type), (0, operators_1.mergeMap)(function () {
        return (0, rxjs_1.of)(exports.assetsActions.pickClear());
    }));
};
exports.assetsUnpickEpic = assetsUnpickEpic;
var assetsUpdateEpic = function (action$, state$) {
    return action$.pipe((0, operators_1.filter)(exports.assetsActions.updateRequest.match), (0, operators_1.withLatestFrom)(state$), (0, operators_1.mergeMap)(function (_a) {
        var _b = __read(_a, 2), action = _b[0], state = _b[1];
        var _c = action.payload, asset = _c.asset, closeDialogId = _c.closeDialogId, formData = _c.formData;
        return (0, rxjs_1.of)(action).pipe((0, debugThrottle_1.default)(state.debug.badConnection), (0, operators_1.mergeMap)(function () {
            return (0, rxjs_1.from)(client_1.client
                .patch(asset._id)
                .setIfMissing({ opt: {} })
                .setIfMissing({ 'opt.media': {} })
                .set(formData)
                .commit());
        }), (0, operators_1.mergeMap)(function (updatedAsset) {
            return (0, rxjs_1.of)(exports.assetsActions.updateComplete({
                asset: updatedAsset,
                closeDialogId: closeDialogId
            }));
        }), (0, operators_1.catchError)(function (error) {
            return (0, rxjs_1.of)(exports.assetsActions.updateError({
                asset: asset,
                error: {
                    message: (error === null || error === void 0 ? void 0 : error.message) || 'Internal error',
                    statusCode: (error === null || error === void 0 ? void 0 : error.statusCode) || 500
...
exports.selectAssetById = (0, toolkit_1.createSelector)([
...
exports.selectAssets = (0, toolkit_1.createSelector)([selectAssetsByIds, selectAssetsAllIds], function (byIds, allIds) { return allIds.map(function (id) { return byIds[id]; }); });
exports.selectAssetsLength = (0, toolkit_1.createSelector)([exports.selectAssets], function (assets) { return assets.length; });
exports.selectAssetsPicked = (0, toolkit_1.createSelector)([exports.selectAssets], function (assets) {
    return assets.filter(function (item) { return item === null || item === void 0 ? void 0 : item.picked; });
});
exports.selectAssetsPickedLength = (0, toolkit_1.createSelector)([exports.selectAssetsPicked], function (assetsPicked) { return assetsPicked.length; });
