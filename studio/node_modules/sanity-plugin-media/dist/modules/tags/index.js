...
var tagsSlice = (0, toolkit_1.createSlice)({
    ...
    reducers: {
        ...
        fetchRequest: {
            ...
            prepare: function () {
                // Construct query
                var query = (0, groq_1.default)(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n          {\n            \"items\": *[\n              _type == \"", "\"\n              && !(_id in path(\"drafts.**\"))\n            ] {\n              _createdAt,\n              _updatedAt,\n              _id,\n              _rev,\n              _type,\n              name\n            } | order(name.current asc),\n          }\n        "], ["\n          {\n            \"items\": *[\n              _type == \"", "\"\n              && !(_id in path(\"drafts.**\"))\n            ] {\n              _createdAt,\n              _updatedAt,\n              _id,\n              _rev,\n              _type,\n              name\n            } | order(name.current asc),\n          }\n        "])), constants_1.TAG_DOCUMENT_NAME);
...
var tagsCreateEpic = function (action$, state$) {
    return action$.pipe((0, operators_1.filter)(tagsSlice.actions.createRequest.match), (0, operators_1.withLatestFrom)(state$), (0, operators_1.mergeMap)(function (_a) {
        var _b = __read(_a, 2), action = _b[0], state = _b[1];
        var _c = action.payload, assetId = _c.assetId, name = _c.name;
        return (0, rxjs_1.of)(action).pipe((0, debugThrottle_1.default)(state.debug.badConnection), (0, checkTagName_1.default)(name), (0, operators_1.mergeMap)(function () {
        ...
        }), (0, operators_1.mergeMap)(function (result) { return (0, rxjs_1.of)(tagsSlice.actions.createComplete({ assetId: assetId, tag: result })); }), (0, operators_1.catchError)(function (error) {
            return (0, rxjs_1.of)(tagsSlice.actions.createError({
                error: {
...
var tagsDeleteEpic = function (action$, state$) {
    return action$.pipe((0, operators_1.filter)(tagsSlice.actions.deleteRequest.match), (0, operators_1.withLatestFrom)(state$), (0, operators_1.mergeMap)(function (_a) {
        var _b = __read(_a, 2), action = _b[0], state = _b[1];
        var tag = action.payload.tag;
        ...
        (0, operators_1.mergeMap)(function () { return (0, rxjs_1.of)(tagsSlice.actions.deleteComplete({ tagId: tag._id })); }), (0, operators_1.catchError)(function (error) {
            return (0, rxjs_1.of)(tagsSlice.actions.deleteError({
                error: {
                    message: (error === null || error === void 0 ? void 0 : error.message) || 'Internal error',
                    statusCode: (error === null || error === void 0 ? void 0 : error.statusCode) || 500
                },
...
var tagsFetchEpic = function (action$, state$) {
    return action$.pipe((0, operators_1.filter)(tagsSlice.actions.fetchRequest.match), (0, operators_1.withLatestFrom)(state$), (0, operators_1.switchMap)(function (_a) {
        var _b = __read(_a, 2), action = _b[0], state = _b[1];
        ...
        (0, operators_1.mergeMap)(function (result) {
            ...
            return (0, rxjs_1.of)(tagsSlice.actions.fetchComplete({ tags: items }));
        }), (0, operators_1.catchError)(function (error) {
            return (0, rxjs_1.of)(tagsSlice.actions.fetchError({
                error: {
                    message: (error === null || error === void 0 ? void 0 : error.message) || 'Internal error',
                    statusCode: (error === null || error === void 0 ? void 0 : error.statusCode) || 500
                }
...
var tagsListenerCreateQueueEpic = function (action$) {
    return action$.pipe((0, operators_1.filter)(tagsSlice.actions.listenerCreateQueue.match), (0, operators_1.bufferTime)(2000), (0, operators_1.filter)(function (actions) { return actions.length > 0; }), (0, operators_1.mergeMap)(function (actions) {
        var tags = actions === null || actions === void 0 ? void 0 : actions.map(function (action) { return action.payload.tag; });
        return (0, rxjs_1.of)(tagsSlice.actions.listenerCreateQueueComplete({ tags: tags }));
    }));
};
...
var tagsListenerDeleteQueueEpic = function (action$) {
    return action$.pipe((0, operators_1.filter)(tagsSlice.actions.listenerDeleteQueue.match), (0, operators_1.bufferTime)(2000), (0, operators_1.filter)(function (actions) { return actions.length > 0; }), (0, operators_1.mergeMap)(function (actions) {
        var tagIds = actions === null || actions === void 0 ? void 0 : actions.map(function (action) { return action.payload.tagId; });
        return (0, rxjs_1.of)(tagsSlice.actions.listenerDeleteQueueComplete({ tagIds: tagIds }));
    }));
};
...
var tagsListenerUpdateQueueEpic = function (action$) {
    return action$.pipe((0, operators_1.filter)(tagsSlice.actions.listenerUpdateQueue.match), (0, operators_1.bufferTime)(2000), (0, operators_1.filter)(function (actions) { return actions.length > 0; }), (0, operators_1.mergeMap)(function (actions) {
        var tags = actions === null || actions === void 0 ? void 0 : actions.map(function (action) { return action.payload.tag; });
        return (0, rxjs_1.of)(tagsSlice.actions.listenerUpdateQueueComplete({ tags: tags }));
    }));
};
...
var tagsSortEpic = function (action$) {
    return action$.pipe((0, redux_observable_1.ofType)(tagsSlice.actions.listenerCreateQueueComplete.type, tagsSlice.actions.listenerUpdateQueueComplete.type), (0, operators_1.bufferTime)(1000), (0, operators_1.filter)(function (actions) { return actions.length > 0; }), (0, operators_1.mergeMap)(function () { return (0, rxjs_1.of)(tagsSlice.actions.sort()); }));
};
...
var tagsUpdateEpic = function (action$, state$) {
    return action$.pipe((0, operators_1.filter)(tagsSlice.actions.updateRequest.match), (0, operators_1.withLatestFrom)(state$), (0, operators_1.mergeMap)(function (_a) {
        var _b;
        ...
        (0, checkTagName_1.default)((_b = formData === null || formData === void 0 ? void 0 : formData.name) === null || _b === void 0 ? void 0 : _b.current), 
        ...
        // Dispatch complete action
        (0, operators_1.mergeMap)(function (updatedTag) {
            return (0, rxjs_1.of)(tagsSlice.actions.updateComplete({
                closeDialogId: closeDialogId,
                tag: updatedTag
            }));
        }), (0, operators_1.catchError)(function (error) {
            return (0, rxjs_1.of)(tagsSlice.actions.updateError({
                error: {
                    message: (error === null || error === void 0 ? void 0 : error.message) || 'Internal error',
                    statusCode: (error === null || error === void 0 ? void 0 : error.statusCode) || 500
                },
...
exports.selectTags = (0, toolkit_1.createSelector)([selectTagsByIds, selectTagsAllIds], function (byIds, allIds) { return allIds.map(function (id) { return byIds[id]; }); });
exports.selectTagById = (0, toolkit_1.createSelector)([selectTagsByIds, function (_state, tagId) { return tagId; }], function (byIds, tagId) { return byIds[tagId]; });
...
var selectTagSelectOptions = function (asset) { return function (state) {
    ...
    if (tags && (tags === null || tags === void 0 ? void 0 : tags.length) > 0) {
        return (0, getTagSelectOptions_1.default)(tags);
    }
    return null;
}; };
