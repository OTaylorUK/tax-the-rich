...
var uploadsSlice = (0, toolkit_1.createSlice)({
    name: 'uploads',
...
var uploadsAssetStartEpic = function (action$) {
    return action$.pipe((0, operators_1.filter)(exports.uploadsActions.uploadStart.match), (0, operators_1.mergeMap)(function (action) {
        var _a = action.payload, file = _a.file, uploadItem = _a.uploadItem;
        return (0, rxjs_1.merge)(
        // Generate low res preview
        (0, rxjs_1.of)(null).pipe((0, operators_1.mergeMap)(function () { return (0, generatePreviewBlobUrl_1.generatePreviewBlobUrl$)(file); }), (0, operators_1.mergeMap)(function (url) {
            return (0, rxjs_1.of)(exports.uploadsActions.previewReady({
                blobUrl: url,
                hash: uploadItem.hash
            }));
        })), 
        // Upload asset and receive progress / complete events
        (0, rxjs_1.of)(null).pipe(
        // delay(500000), // debug uploads
        (0, operators_1.mergeMap)(function () { return (0, uploadSanityAsset_1.uploadAsset$)(uploadItem.assetType, file, uploadItem.hash); }), (0, operators_1.takeUntil)(action$.pipe((0, operators_1.filter)(exports.uploadsActions.uploadCancel.match), (0, operators_1.filter)(function (v) { return v.payload.hash === uploadItem.hash; }))), (0, operators_1.mergeMap)(function (event) {
            if ((event === null || event === void 0 ? void 0 : event.type) === 'complete') {
                return (0, rxjs_1.of)(exports.uploadsActions.uploadComplete({
                    asset: event.asset
                }));
            }
            if ((event === null || event === void 0 ? void 0 : event.type) === 'progress' && (event === null || event === void 0 ? void 0 : event.stage) === 'upload') {
                return (0, rxjs_1.of)(exports.uploadsActions.uploadProgress({
                    event: event,
            ...
            return (0, rxjs_1.of)(exports.uploadsActions.uploadError({
                error: {
...
var uploadsAssetUploadEpic = function (action$, state$) {
    return action$.pipe((0, operators_1.filter)(exports.uploadsActions.uploadRequest.match), (0, operators_1.withLatestFrom)(state$), (0, operators_1.mergeMap)(function (_a) {
        ...
        (0, operators_1.mergeMap)(function () { return (0, uploadSanityAsset_1.hashFile$)(file); }), 
        // Ignore if the file exists and is currently being uploaded
        (0, operators_1.filter)(function (hash) {
            var exists = !!state.uploads.byIds[hash];
            return !exists;
        }), 
        // Dispatch start action and begin upload process
        (0, operators_1.mergeMap)(function (hash) {
            ...
            return (0, rxjs_1.of)(exports.uploadsActions.uploadStart({ file: file, uploadItem: uploadItem }));
        }));
    }));
};
exports.uploadsAssetUploadEpic = uploadsAssetUploadEpic;
var uploadsCompleteQueueEpic = function (action$) {
    return action$.pipe((0, operators_1.filter)(exports.uploadsActions.uploadComplete.match), (0, operators_1.mergeMap)(function (action) {
        return (0, rxjs_1.of)(exports.uploadsActions.checkRequest({
...
var uploadsCheckRequestEpic = function (action$, state$) {
    return action$.pipe((0, operators_1.filter)(exports.uploadsActions.checkRequest.match), (0, operators_1.withLatestFrom)(state$), (0, operators_1.mergeMap)(function (_a) {
        var _b = __read(_a, 2), action = _b[0], state = _b[1];
        ...
        return (0, rxjs_1.of)(action).pipe((0, operators_1.delay)(1000), // give Sanity some time to register the recently uploaded asset
        (0, operators_1.mergeMap)(function () { return client_1.client.observable.fetch(query, { documentIds: documentIds }); }), (0, operators_1.mergeMap)(function (resultHashes) {
            ...
            return (0, rxjs_1.of)(exports.uploadsActions.checkComplete({ results: checkedResults }), //
...
exports.selectUploadById = (0, toolkit_1.createSelector)([
...
exports.selectUploads = (0, toolkit_1.createSelector)([selectUploadsByIds, selectUploadsAllIds], function (byIds, allIds) { return allIds.map(function (id) { return byIds[id]; }); });
