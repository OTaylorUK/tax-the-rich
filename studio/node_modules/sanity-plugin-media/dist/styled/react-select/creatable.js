...
exports.reactSelectStyles = {
    control: function (styles, _a) {
        ...
        var boxShadow = "inset 0 0 0 1px ".concat(color_1.hues.gray[900].hex);
        if (isFocused) {
            boxShadow = "inset 0 0 0 1px ".concat(color_1.hues.gray[900].hex, ", 0 0 0 1px var(--card-bg-color), 0 0 0 3px var(--card-focus-ring-color) !important");
        }
        return __assign(__assign({}, styles), { background: isDisabled
                ...
                boxShadow: "inset 0 0 0 1px ".concat(ui_1.studioTheme.color.dark.default.input.default.hovered.border)
            } });
    },
