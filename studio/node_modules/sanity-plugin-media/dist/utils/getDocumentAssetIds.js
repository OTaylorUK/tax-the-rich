...
var getAssetIds = function (node, acc) {
    ...
    if (isPlainObject(node)) {
        if (((_a = node === null || node === void 0 ? void 0 : node.asset) === null || _a === void 0 ? void 0 : _a._type) === 'reference' && ((_b = node === null || node === void 0 ? void 0 : node.asset) === null || _b === void 0 ? void 0 : _b._ref)) {
...
var getDocumentAssetIds = function (document) {
    var assetIds = getAssetIds(document);
    // Sort and dedupe
    return __spreadArray([], __read(new Set(assetIds.sort())), false);
};
exports.default = getDocumentAssetIds;
//# sourceMappingURL=getDocumentAssetIds.js.map