...
var hexFromBuffer = function (buffer) {
    return Array.prototype.map
        .call(new Uint8Array(buffer), function (x) { return "00".concat(x.toString(16)).slice(-2); })
        .join('');
};
var hashFile$ = function (file) {
    ...
    return readFile$(file).pipe((0, operators_1.mergeMap)(function (arrayBuffer) { return window.crypto.subtle.digest('SHA-1', arrayBuffer); }), (0, operators_1.map)(hexFromBuffer));
};
exports.hashFile$ = hashFile$;
var uploadSanityAsset$ = function (assetType, file, hash) {
    return (0, rxjs_1.of)(null).pipe(
    // NOTE: the sanity api will still dedupe unique files, but this saves us from uploading the asset file entirely
    (0, operators_1.mergeMap)(function () { return fetchExisting$("sanity.".concat(assetType, "Asset"), hash); }), 
    // Cancel if the asset already exists
    (0, operators_1.mergeMap)(function (existingAsset) {
        if (existingAsset) {
            return (0, rxjs_1.throwError)({
        ...
        return client_1.client.observable.assets
            ...
            .pipe((0, operators_1.map)(function (event) {
...
exports.uploadAsset$ = (0, withMaxConcurrency_1.withMaxConcurrency)(uploadSanityAsset$);
