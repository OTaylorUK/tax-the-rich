...
var createThrottler = function (concurrency) {
        ...
        return new rxjs_1.Observable(function (observer) {
            if (currentSubscriptions.length >= concurrency) {
                return scheduleAndWait$(observable)
                    .pipe((0, operators_1.mergeMap)(request)) //
                    .subscribe(observer);
            }
    ...
    function scheduleAndWait$(observable) {
        ...
        return ready$.asObservable().pipe((0, operators_1.first)(function (obs) { return obs === observable; }));
    }
    return request;
};
...
var withMaxConcurrency = function (func, concurrency) {
    if (concurrency === void 0) { concurrency = DEFAULT_CONCURRENCY; }
    var throttler = (0, exports.createThrottler)(concurrency);
    return function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        return (0, rxjs_1.from)(throttler(func.apply(void 0, __spreadArray([], __read(args), false))));
    };
};
